    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    This fun and creative project turns an old plastic bottle
                    into a cute and useful piggy bank! Instead of throwing away
                    plastic bottles, you can give them a new purpose by
                    transforming them into an adorable pink pig where you can
                    save your spare coins. It’s a great way to practice
                    recycling, creativity, and money-saving habits at the same
                    time. Perfect for students who love crafts and want to help
                    protect the environment while learning the value of saving!
                </Text>
                <View
                    style={{
                        marginTop: 20,
